...
# Question by topics
+ [Object Oriented Programmin](#object-oriented-programming)
...
+ [Coming soon..](#java-ninja)

[Table of content](#java-ninja)

## Java Core
+ [What does PECS stand for?](core.md#what-does-pecs-stand-for)
+ [What are wildcards and their types?](core.md#what-are-wildcards-and-their-types)
...
+ [What Is the Meaning of `String::Valueof` Expression?](java8.md#what-is-the-meaning-of-stringvalueof-expression)
